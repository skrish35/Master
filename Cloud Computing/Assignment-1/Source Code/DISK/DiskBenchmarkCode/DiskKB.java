...
// File and Buffered writer to write inside a file
...
//calculation of latency and throughput
	double latency1= (((totaltime1)/(KB))*1000);
	double throughput1=(KB)/(1024*totaltime1);
System.out.println("---------------------------------------------------------------------");
	...
	double latency2= (((totaltime2)/(KB))*1000);
	double throughput2=((KB)/(1024*totaltime2));
	...
	double latency3= (((totaltime3)/(KB))*1000);
	double throughput3=((KB)/(1024*1024*totaltime3));
	...
	double latency4= (((totaltime4)/(KB))*1000);
	double throughput4=((KB)/(1024*1024*totaltime4));
