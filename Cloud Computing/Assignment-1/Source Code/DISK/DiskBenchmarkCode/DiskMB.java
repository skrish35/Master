...
// start and finish barrier initializations of time interval
...
//calculation of latency and throughput
	double latency1= (((totaltime1)/MB)*1000);
	double throughput1=((MB)/(totaltime1));
System.out.println("---------------------------------------------------------------------");
	...
	double latency2= (((totaltime2)/(MB))*1000);
	double throughput2=((MB)/(totaltime2));
	...
	double latency3= (((totaltime3)/(MB))*1000);
	double throughput3=((MB)/(totaltime3));
	...
	double latency4= (((totaltime4)/(MB))*1000);
	double throughput4=((MB)/(totaltime4));
