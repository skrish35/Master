...
public class IndividualProductServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("0000000000000"+request.getParameter("productId"));
		String html="";
		...
		//}
    	html=html+"</table></form></div> <button class='input-button' style='width: 200px; height: 50px; background-color: green;'  name='commit' id='commit' tabindex='3' ><a href='AllProductsPageServlet' style='text-decoration:none;color:white;'>  Back </a></button></body> <script type='text/javascript'	src='./AutoComplete.js'></script></html>";
		out.println(html);
	}
